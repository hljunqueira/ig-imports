...
export const getRequestById = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao buscar solicitação' });
    }
};
...
export const updateStatus = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao atualizar status da solicitação' });
    }
};
...
export const assignRequest = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao atribuir solicitação' });
    }
};
...
export const quoteRequest = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao enviar orçamento' });
    }
};
...
export const deleteRequest = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao excluir solicitação' });
    }
};
...
export const getRequestStats = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(500).json({ success: false, error: 'Erro ao buscar estatísticas de solicitações' });
    }
};
